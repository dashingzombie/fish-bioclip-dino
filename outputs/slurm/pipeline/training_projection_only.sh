...
torchrun --standalone --nproc_per_node=4 -m fish_vlm.cli train --config /faststorage/project/worm-species/fish-bioclip-dino/configs/train/projection_only.yaml
