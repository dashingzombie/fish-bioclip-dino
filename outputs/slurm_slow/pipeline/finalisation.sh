...
python -m fish_vlm.cli package-submission --submission /faststorage/project/worm-species/fish-bioclip-dino/outputs/submissions/prediction.json --output /faststorage/project/worm-species/fish-bioclip-dino/outputs/submissions/submission.zip
